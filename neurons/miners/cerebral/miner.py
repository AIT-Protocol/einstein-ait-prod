...
class CerebralMiner(Miner):
    """
    Base miner which runs Cerebral (https://huggingface.co/ait-protocol/Cerebral-7b-beta)    
    ...
    def __init__(self, config=None):
        ...
        if self.config.wandb.on:
            self.identity_tags = ("cerebral_miner",)
        ...
        bt.logging.info(f"🧠 Cerebral current system prompt: {self.system_prompt}")
